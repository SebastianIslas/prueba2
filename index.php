...
<head>
<title>Tienda Tecla Academy Prueba</title>
<meta charset="utf-8">
...
<div class="bgded overlay" style="background-image:url('images/demo/backgrounds/01.png');"> 
  ...
  <div class="wrapper row0">
    <header id="header" class="hoc clear center"> 
      <!-- ################################################################################################ -->
      <h1 id="logo"><i class="fas fa-truck-loading"></i> <a href="index.php">Tienda Tecla Academy</a></h1>
      <!-- ################################################################################################ -->
    </header>
  </div>
  <!-- ################################################################################################ -->
    ...
    <nav id="mainav" class="hoc clear"> 
      ...
      <ul class="clear">
        ...
        <li><a class="drop" href="#">Categorias</a>
          <ul>
            <li><a href="index_demo_2.html">Mas buscados</a></li>
          </ul>
        </li>
        <li><a href="checkout_demo.html">Carrito</a></li>
        <li><a href="login_demo.html">Iniciar sesion</a></li>
      </ul>
      <!-- ################################################################################################ -->
    </nav>
  </div>
  ...
  <div id="pageintro" class="hoc clear"> 
    ...
    <article>
      ...
      <p>Aqui puedes checar que productos comprar</p>
      <footer><a class="btn" href="#">Comprar</a></footer>
    </article>
    <!-- ################################################################################################ -->
  </div>
  <!-- ################################################################################################ -->
...
<div class="wrapper row5">
  <div id="copyright" class="hoc clear"> 
    <!-- ################################################################################################ -->
    <p class="fl_left">Copyright &copy; 2021 - Todos los Derechos Reservados - <a href="#">Domain Name</a></p>
    <!-- ################################################################################################ -->
  </div>
</div>
<!-- ################################################################################################ -->
